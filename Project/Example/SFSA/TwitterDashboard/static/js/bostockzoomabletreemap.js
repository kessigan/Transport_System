	...
	*/
	...
	d3.select("#treechart").select("svg").remove();
	...
	// height = window.innerHeight/1.5 - margin.top - margin.bottom- margin.top - margin.bottom ,
	width = Math.ceil(window.innerWidth/2),
	height = Math.ceil(window.innerHeight/1.9) - margin.top - margin.bottom- margin.top - margin.bottom ,
	// width = 1000,
	...
	grandparent.append("text")
		...
		function display(d) {
			...
			g.append("rect")
				...
				// .on("click", function(d) { 
					// if(!d.children){
						// // d3.select("#textreports").attr("style","background-color:#D8D8D8; font-size:4;").text(d.display_text).style("color", "black");
						// // post(d.name);
// 						
						// //Code from http://stackoverflow.com/questions/19333098/403-forbidden-error-when-making-an-ajax-post-request-in-django-framework/26100613#26100613
...
// 
						...
						// });
// 						
						// console.log('../ndpviz/chapterform/');
						// $.post('../ndpviz/chapterform/', {
																		        // name: "key",
																		        // value: d.name_value
    																	  // } );
//     																	 
    					...
    					// // console.log(d.url);											  
						// // window.location='/ndpviz/newview';
						// // window.open(d.url); 
// 
					// }
				// })
			...
			g.append("foreignObject")
				...
				.on("click", function(d) { 
					if(!d.children){
						...
						// console.log("in the foreign object");
						// post(d.name);
						window.location=d.url;

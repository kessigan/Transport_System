...
\begin{table}[ht!]
\centering
\caption{Expected Inputs and Outputs}
\label{my-label}
\begin{tabular}{|l|l|l|}
\hline
                                             & INPUT                                                                                                 & OUTPUT                                                           \\ \hline
Scheduling,Capacity,Goods transferred/Pickup & \begin{tabular}[c]{@{}l@{}}dispatch point\\ destination point\\ date\\ dimensions\\ time\end{tabular} & \begin{tabular}[c]{@{}l@{}}driver\\ vehicle\\ route\end{tabular} \\ \hline
\end{tabular}
\end{table}
